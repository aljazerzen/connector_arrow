...
1. [Install nix (the package manager)](https://nixos.org/download). (only first time)
...
Optionally, you can install [direnv](https://direnv.net/), to automatically load the shell when you
enter this repo. The easiest way is to also install
[direnv-nix](https://github.com/nix-community/nix-direnv) and configure your `.envrc` with:
